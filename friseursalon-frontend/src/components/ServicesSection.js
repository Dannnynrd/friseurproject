...
// KORREKTUR: Icons aus den richtigen Bibliotheken importiert
import { FiClock, FiArrowRight } from 'react-icons/fi';
import { FaEuroSign } from 'react-icons/fa'; // Das korrekte Euro-Icon aus der Font-Awesome-Bibliothek

// Hilfskomponente für eine einzelne Service-Karte
        ...
        <div ref={cardRef} className={styles.serviceCard}>
            ...
            <div className={styles.contentWrapper}>
                ...
                <div className={styles.detailsList}>
                    ...
                    <span className={styles.detailItem}>
                        {/* KORREKTUR: Die Komponente heißt jetzt FaEuroSign */}
        ...
        <section id="services-section" className={styles.servicesSection}>
            <div className={styles.container}>
                ...
                <div className={styles.fullListButtonContainer}>
                    <button onClick={() => navigate('/services')} className={styles.fullListButton}>
